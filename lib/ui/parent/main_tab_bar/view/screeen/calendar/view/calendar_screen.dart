...
import '../../../../../../teacher/teacher_bottom_tab/view/screens/home/view/report/controller/report_controller.dart';
import '../../../../../../teacher/teacher_bottom_tab/view/screens/home/view/report/model/teacher_holiday_event_list/teacher_holiday_event_list_response.dart';
                ...
                return ListTile(
                  title: Text(
                    ...
                    style: TextStyle(
                      ...
                      color:
                          isSelected ? const Color(0xFF00BCD4) : Colors.black,
                    ),
                  ),
                  onTap: () {
                    setState(() {
  ...
  Widget _navButton(IconData icon, VoidCallback onTap) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child:
            Icon(icon, size: 28, color: light ? Colors.black87 : Colors.white),
      ),
    );
  }
      ...
      children: [
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 11,
                        color:
                            light ? Colors.grey.shade500 : Colors.grey.shade600,
                      ),
                    ),
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w500,
                        color: light ? const Color(0xFF1A1A2E) : Colors.white,
                        height: 1.4,
                      ),
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
        ...
        if (showDivider)
          Divider(
            ...
            thickness: 0.5,
            color:
                light ? Colors.grey.shade100 : Colors.white.withValues(alpha: 0.06),
          ),
      ],
    );
  }
