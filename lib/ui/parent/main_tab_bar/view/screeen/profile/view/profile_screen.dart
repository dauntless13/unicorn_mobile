...
import '../update_parent_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 0), () async {
      controller.parentGetBySlug(context);
    });
  }
  ...
  Widget _profileHeader(BuildContext context) {
    return Obx(() {
      final data = controller.parent.value;
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    controller.isLoading.value ? "-" : data.email ?? "",
                    style: const TextStyle(
    ...
    return _card(
      ...
      children: [
        _item(context,
            ...
            title: 'my_account'.tr,
            subtitle: 'my_account_desc'.tr,
            onTap: () => Get.to(() => const EditParentProfileScreen())),
        _item(context,
            ...
            _card(
              ...
              children: [
                ...
                _item(
                  ...
                  onTap: () {
                    print(data?.urls?.privacyPolicyUrl);
                    Get.to(
                      WebViewScreen(),
                      arguments: [
                        'privacy_policy'.tr,
                        data?.urls?.privacyPolicyUrl,
                      ],
                    );
                  },
                ),
                _item(
                  ...
                  onTap: () {
                    Get.to(
                      ...
                      arguments: [
                        'terms_conditions'.tr,
                        data?.urls?.termsAndConditionsUrl,
                      ],
                    );
                  },
                ),
